...
from shop.views import Homepage, ProductsListView, SearchProductsView, ProductDetailView, ContactView, AboutUsView, \
...
urlpatterns = [
    ...
    path('delivery-payment/', DeliveryPaymentView.as_view(), name='delivery-payment'),
    ...
    path('shop/<slug:slug_category>/', ProductsListView.as_view(), name='products_by_category'),
